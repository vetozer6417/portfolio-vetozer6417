...
export default function Aboutme() {
    return (
        <section className="grid grid-cols-2 gap-4 bg-[#e5e5e5] px-5 py-5">
            <div className="items-center w-full h-[500px] bg-primary">

            </div>
            <div className="flex flex-col">
                <p className="text-lg">Hello I'm</p>
                <h1 className="font-lato font-bold italic text-5xl">Theerat Punyasit</h1>
                <p>Full Stack Web Developer and UX/UI Designer</p>
                <div className="bg-primary border-t-[1px] border-t-black border-l-[1px] border-l-black border-b-[1px] border-b-white border-r-[1px] border-r-white mt-3 px-2 py-2 w-8/12 flex items-center text-center h-[120px]">
